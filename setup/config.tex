...
% 繁體中文章標題顯示格式
\newcommand{\thesisChapterTitleFormatZHTW}{\zhnumber{\thechapter}、}

% 繁體中文章標題目錄顯示格式
\newcommand{\thesisChapterTitleTocFormatZHTW}{\zhnumber{\thecontentslabel}、}

% 繁體中文附錄章標題顯示格式
\newcommand{\thesisAppendixTitleFormatZHTW}{\thesisAppendixTitleZHTW\zhnumber{\thechapter}、}

% 繁體中文附錄章標題目錄顯示格式
\newcommand{\thesisAppendixTitleTocFormatZHTW}{\thesisAppendixTitleZHTW\zhnumber{\thecontentslabel}、}
...
% 英文標題顯示格式
\newcommand{\thesisChapterTitleFormatEN}{Chapter~\thechapter~}

% 英文目錄標題顯示格式
\newcommand{\thesisChapterTitleTocFormatEN}{Chapter~\thecontentslabel~}

% 英文附錄章標題顯示格式
\newcommand{\thesisAppendixTitleFormatEN}{\thesisAppendixTitleEN~\thechapter~}

% 英文附錄章標題目錄顯示格式
\newcommand{\thesisAppendixTitleTocFormatEN}{\thesisAppendixTitleEN~\thecontentslabel~}
