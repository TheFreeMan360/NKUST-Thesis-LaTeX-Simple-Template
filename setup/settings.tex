...
\ifthenelse{\equal{\thesisUseZHTW}{Y}}{
    ...
    % 章標題顯示格式
    \newcommand{\thesisChapterTitleFormat}{\thesisChapterTitleFormatZHTW{\thechapter}}
    \newcommand{\thesisChapterTitleTocFormat}{\thesisChapterTitleFormatZHTW{\thecontentslabel}}

    % 附錄章標題顯示格式
    \newcommand{\thesisAppendixTitleFormat}{\thesisAppendixTitleFormatZHTW{\thechapter}}
    \newcommand{\thesisAppendixTitleTocFormat}{\thesisAppendixTitleFormatZHTW{\thecontentslabel}}
    ...
    % 章標題顯示格式
    \newcommand{\thesisChapterTitleFormat}{\thesisChapterTitleFormatEN{\thechapter}}
    \newcommand{\thesisChapterTitleTocFormat}{\thesisChapterTitleFormatEN{\thecontentslabel}}

    % 附錄章標題顯示格式
    \newcommand{\thesisAppendixTitleFormat}{\thesisAppendixTitleFormatEN{\thechapter}}
    \newcommand{\thesisAppendixTitleTocFormat}{\thesisAppendixTitleFormatEN{\thecontentslabel}}
...
% enumitem 設定
\setlist[enumerate, 1]{ % 第一層列表
    label=\arabic*.,
    before=\setlength{\parindent}{2em}, % 內容首行縮排
}

\setlist[enumerate, 2]{ % 第二層列表
    label=(\arabic*),
    before=\setlength{\parindent}{2em}, % 內容首行縮排
}

\setlist[enumerate, 3]{ % 第三層列表
    label=\alph*.,
    before=\setlength{\parindent}{2em}, % 內容首行縮排
}
